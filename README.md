...
The code in this repository, as a derivative work of the course's original source code, is licensed under the [GNU General Public License v3.0](https://github.com/OmarGeasaa/Robot-Mapping-with-LiDAR-Data/blob/main/LICENSE). The full license text is available in the `LICENSE` file.
